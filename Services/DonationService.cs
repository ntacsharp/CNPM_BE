...
//        {
//            var list = await _context.HouseholdDonation.Skip(req.Skip * req.Take).Take(req.Take).ToListAsync();
//            var resp = new List<HouseholdDonation>();
//            foreach ( var hd in list)
//            {
//                var hh = await _context.Household.FirstOrDefaultAsync(h => h.Id == hd.DonatorId);
//                if (hh.ManagerId == user.Id) resp.Add(hd);
//            }
//            return resp;
//        }
//    }
