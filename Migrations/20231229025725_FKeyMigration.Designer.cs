...
namespace CNPM_BE.Migrations
{
    ...
    [Migration("20231229025725_FKeyMigration")]
    partial class FKeyMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CNPM_BE.Models.Vehicle", b =>
                {
                    ...
                    b.HasIndex("ApartmentId")
                        .HasDatabaseName("ix_vehicle_apartment_id");
            ...
            modelBuilder.Entity("CNPM_BE.Models.Vehicle", b =>
                {
                    b.HasOne("CNPM_BE.Models.Apartment", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_vehicle_apartment_apartment_id");
